        ...
        <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    ...
                    <section class="home-section">
                            ...
                            <div class="section-intro">
                                ...
                                <div class="section-paragraph text24"><?php echo get_field('home_second_paragraph'); ?></div>
                            </div>
                    </section>
            ...
            <div class="swiper-slide">
                ...
                <section class="process-section">
                        ...
                        <circle cx="25" cy="40" r="6" fill="#fff" />
                        <circle cx="70" cy="145" r="6" fill="#fff" />
                        <circle cx="73" cy="270" r="6" fill="#fff" />
                        <circle cx="30" cy="395" r="6" fill="#fff" />
                        </svg>
